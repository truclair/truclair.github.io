...
__name(formatContactPreference, "formatContactPreference");
var COMMISSION_TYPE_LABELS = {
  head: "Headshot",
  half: "Half Body",
  full: "Full Body"
};
var COMMISSION_STATUS_LABELS = {
  Pending: "Pending",
...
__name(formatCommissionType, "formatCommissionType");
function formatCommissionStatus(status) {
  return COMMISSION_STATUS_LABELS[status] || status;
}
__name(formatCommissionStatus, "formatCommissionStatus");
...
__name(ensureStatusToken, "ensureStatusToken");
...
__name(handleGetCommissionByStatusToken, "handleGetCommissionByStatusToken");
...
// .wrangler/tmp/bundle-DFUpPg/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-DFUpPg/middleware-loader.entry.ts
